	...
	<div class="display no-border">
		...
		<div class="footer">
			...
			try { //if license is provided by core, UI is now only a library. Treat it like that
				...
				echo str_replace('%license', '<a href="javascript:;" onclick="$(\'#licensePopupUI\').dialog(\'open\'); return false;">' . _('CC-BY-NC-ND-4.0') . '</a>', str_replace('%modulename', '<a target="_blank" href="https://github.com/Massi-X/freepbx-carddavmiddleware-ui/blob/main/LICENSE">' . _('CardDAV Middleware UI') . '</a>', _('%modulename licensed under %license')));
			}
			?>
			&#32;-&#32;
			<!-- Libraries and links -->
		...
		<div id="librariesPopup" title="<?= _('Open source libraries'); ?>" style="display: none">
			<ul>
				...
				if ($license) //if license is provided by core, UI is now only a library. Treat it like that
					echo '<li><a target="_blank" href="https://github.com/Massi-X/freepbx-carddavmiddleware-ui/blob/main/LICENSE">' . _('CardDAV Middleware UI') . '</a></li>';
				?>
